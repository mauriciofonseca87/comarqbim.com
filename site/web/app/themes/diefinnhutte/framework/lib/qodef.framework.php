...
/*
   Class: DieFinnhutteSelectClassFramework
...
class DieFinnhutteSelectClassFramework {
	...
	private function __construct() {
		$this->qodeOptions         = DieFinnhutteSelectClassOptions::get_instance();
		$this->qodeMetaBoxes       = DieFinnhutteSelectClassMetaBoxes::get_instance();
		$this->qodeTaxonomyOptions = DieFinnhutteSelectClassTaxonomyOptions::get_instance();
		$this->qodeUserOptions     = DieFinnhutteSelectClassUserOptions::get_instance();
		$this->qodeDashboardOptions = DieFinnhutteSelectClassDashboardOptions::get_instance();
	}
	...
	public function setSkin( DieFinnhutteSelectClassSkinAbstract $skinObject ) {
		$this->skin = $skinObject;
	}
}

/**
 * Class DieFinnhutteSelectClassSkinManager
 *
...
class DieFinnhutteSelectClassSkinManager {
	...
	/**
	 * @see DieFinnhutteSelectClassSkinManager::setSkin()
	 */
	...
	private function setSkin( $skinName = SELECT_PROFILE_SLUG ) {
		if ( $skinName !== '' ) {
			if ( file_exists( get_template_directory() . '/framework/admin/skins/' . $skinName . '/skin.php' ) ) {
				...
				$skinName = ucfirst( $skinName ) . esc_html__( 'Skin', 'diefinnhutte' );
...
/**
 * Class DieFinnhutteSelectClassSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class DieFinnhutteSelectClassSkinAbstract {
	/**
	 * @var string
	 */
	protected $skinName;
	...
	public function loadTemplatePart( $template, $params = array() ) {
		...
		if ( $template !== '' ) {
			include( diefinnhutte_select_find_template_path( 'framework/admin/skins/' . $this->skinName . '/templates/' . $template . '.php' ) );
		}
	}
	...
	public function setShortcodeJSParams() { ?>
		<script>
			window.qodeSCIcon = '<?php echo diefinnhutte_select_get_skin_uri() . '/assets/img/admin-logo-icon.png'; ?>';
			window.qodeSCLabel = '<?php echo esc_html( ucfirst( $this->skinName ) ); ?> <?php esc_html_e( 'Shortcodes', 'diefinnhutte' ) ?>';
		</script>
	<?php }
...
/*
   Class: DieFinnhutteSelectClassOptions
...
class DieFinnhutteSelectClassOptions {
	...
	public function getOptionValue( $key ) {
		...
		if ( array_key_exists( $key, $diefinnhutte_select_global_options ) ) {
			return $diefinnhutte_select_global_options[ $key ];
...
/*
   Class: DieFinnhutteSelectClassAdminPage
   A class that initializes Select Admin Page
*/
class DieFinnhutteSelectClassAdminPage implements iDieFinnhutteSelectInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $slug;
	public $title;
	...
	function __construct( $slug = "", $title_label = "", $icon = "" ) {
		$this->layout  = array();
		$this->factory = new DieFinnhutteSelectClassFieldFactory();
		$this->slug    = $slug;
	...
	public function renderChild( iDieFinnhutteSelectInterfaceRender $child ) {
		$child->render( $this->factory );
	}
}

/*
   Class: DieFinnhutteSelectClassMetaBoxes
...
/*
   Class: DieFinnhutteSelectClassMetaBox
   A class that initializes Select Meta Box
*/
class DieFinnhutteSelectClassMetaBox implements iDieFinnhutteSelectInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	public $title;
	...
	public function setTitle( $label ) {
		...
		return $diefinnhutte_select_global_Framework->getSkin()->getSkinLabel() . ' ' . $label;
	}
}

/*
   Class: DieFinnhutteSelectClassTaxonomyOptions
   A class that initializes DieFinnhutteSelectClass Taxonomy Options
*/
class DieFinnhutteSelectClassTaxonomyOptions {
	private static $instance;
...
/*
   Class: DieFinnhutteSelectClassTaxonomyOption
   A class that initializes DieFinnhutteSelectClass Taxonomy Option
*/
class DieFinnhutteSelectClassTaxonomyOption implements iDieFinnhutteSelectInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new DieFinnhutteSelectClassTaxonomyFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: DieFinnhutteSelectClassUserOptions
   A class that initializes DieFinnhutteSelectClass User Options
*/
class DieFinnhutteSelectClassUserOptions {
	private static $instance;
	public $userOptions;
...
/*
   Class: DieFinnhutteSelectClassUserOption
   A class that initializes DieFinnhutteSelectClass User Option
*/
class DieFinnhutteSelectClassUserOption implements iDieFinnhutteSelectInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new DieFinnhutteSelectClassUserFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: DieFinnhutteSelectClassDashboardOptions
   A class that initializes DieFinnhutteSelectClass Dashboard Options
*/
class DieFinnhutteSelectClassDashboardOptions {
	private static $instance;
...
/*
   Class: DieFinnhutteSelectClassDashboardOption
   A class that initializes DieFinnhutteSelectClass Dashboard Option
*/
class DieFinnhutteSelectClassDashboardOption implements iDieFinnhutteSelectInterfaceLayoutNode {
	public $layout;
	private $factory;
	
	function __construct() {
		$this->layout        = array();
		$this->factory       = new DieFinnhutteSelectClassDashboardFieldFactory();
	}
...
if ( ! function_exists( 'diefinnhutte_select_init_framework_variable' ) ) {
	function diefinnhutte_select_init_framework_variable() {
		global $diefinnhutte_select_global_Framework;
		
		$diefinnhutte_select_global_Framework = DieFinnhutteSelectClassFramework::get_instance();
		$qodeSkinManager                 = new DieFinnhutteSelectClassSkinManager();
		$diefinnhutte_select_global_Framework->setSkin( $qodeSkinManager->getSkin() );
	}
	
	add_action( 'diefinnhutte_select_action_before_options_map', 'diefinnhutte_select_init_framework_variable' );
}
?>