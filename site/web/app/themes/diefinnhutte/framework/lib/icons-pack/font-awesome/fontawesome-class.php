...
if ( ! function_exists( 'diefinnhutte_select_add_font_awesome_icon_pack' ) ) {
	function diefinnhutte_select_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new DieFinnhutteSelectClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_collection', 'diefinnhutte_select_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'diefinnhutte_select_add_font_awesome_icon_pack_option' ) ) {
	function diefinnhutte_select_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'diefinnhutte' );
		
		return $options;
	}
	
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_options', 'diefinnhutte_select_add_font_awesome_icon_pack_option' );
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_social_options', 'diefinnhutte_select_add_font_awesome_icon_pack_option' );
}

class DieFinnhutteSelectClassIconsFontAwesome implements iDieFinnhutteSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
