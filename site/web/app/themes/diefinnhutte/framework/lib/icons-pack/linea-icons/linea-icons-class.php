...
if ( ! function_exists( 'diefinnhutte_select_add_linea_icon_pack' ) ) {
	function diefinnhutte_select_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new DieFinnhutteSelectClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_collection', 'diefinnhutte_select_add_linea_icon_pack' );
}

if ( ! function_exists( 'diefinnhutte_select_add_linea_icon_pack_option' ) ) {
	function diefinnhutte_select_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'diefinnhutte' );
		
		return $options;
	}
	
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_options', 'diefinnhutte_select_add_linea_icon_pack_option' );
}

class DieFinnhutteSelectClassLineaIcons implements iDieFinnhutteSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
