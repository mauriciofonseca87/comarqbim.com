...
if ( ! function_exists( 'diefinnhutte_select_add_font_elegant_icon_pack' ) ) {
	function diefinnhutte_select_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new DieFinnhutteSelectClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_collection', 'diefinnhutte_select_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'diefinnhutte_select_add_font_elegant_icon_pack_option' ) ) {
	function diefinnhutte_select_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'diefinnhutte' );
		
		return $options;
	}
	
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_options', 'diefinnhutte_select_add_font_elegant_icon_pack_option' );
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_social_options', 'diefinnhutte_select_add_font_elegant_icon_pack_option' );
}

class DieFinnhutteSelectClassIconsFontElegant implements iDieFinnhutteSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
