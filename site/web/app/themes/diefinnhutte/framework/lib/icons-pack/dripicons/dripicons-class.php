...
if ( ! function_exists( 'diefinnhutte_select_add_dripicons_icon_pack' ) ) {
	function diefinnhutte_select_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new DieFinnhutteSelectClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_collection', 'diefinnhutte_select_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'diefinnhutte_select_add_dripicons_icon_pack_option' ) ) {
	function diefinnhutte_select_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'diefinnhutte' );
		
		return $options;
	}
	
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_options', 'diefinnhutte_select_add_dripicons_icon_pack_option' );
}

class DieFinnhutteSelectClassDripicons implements iDieFinnhutteSelectInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
