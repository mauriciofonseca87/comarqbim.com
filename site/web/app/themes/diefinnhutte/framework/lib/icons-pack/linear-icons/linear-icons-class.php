...
if ( ! function_exists( 'diefinnhutte_select_add_linear_icon_pack' ) ) {
	function diefinnhutte_select_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new DieFinnhutteSelectClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_collection', 'diefinnhutte_select_add_linear_icon_pack' );
}

if ( ! function_exists( 'diefinnhutte_select_add_linear_icon_pack_option' ) ) {
	function diefinnhutte_select_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'diefinnhutte' );
		
		return $options;
	}
	
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_options', 'diefinnhutte_select_add_linear_icon_pack_option' );
}

class DieFinnhutteSelectClassLinearIcons implements iDieFinnhutteSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
