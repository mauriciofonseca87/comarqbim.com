...
if ( ! function_exists( 'diefinnhutte_select_add_ion_icon_pack' ) ) {
	function diefinnhutte_select_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new DieFinnhutteSelectClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_collection', 'diefinnhutte_select_add_ion_icon_pack' );
}

if ( ! function_exists( 'diefinnhutte_select_add_ion_icon_pack_option' ) ) {
	function diefinnhutte_select_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'diefinnhutte' );
		
		return $options;
	}
	
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_options', 'diefinnhutte_select_add_ion_icon_pack_option' );
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_social_options', 'diefinnhutte_select_add_ion_icon_pack_option' );
}

class DieFinnhutteSelectClassIonIcons implements iDieFinnhutteSelectInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
