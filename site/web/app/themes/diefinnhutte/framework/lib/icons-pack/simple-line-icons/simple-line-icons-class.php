...
if ( ! function_exists( 'diefinnhutte_select_add_simple_line_icon_pack' ) ) {
	function diefinnhutte_select_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new DieFinnhutteSelectClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_collection', 'diefinnhutte_select_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'diefinnhutte_select_add_simple_line_icon_pack_option' ) ) {
	function diefinnhutte_select_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'diefinnhutte' );
		
		return $options;
	}
	
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_options', 'diefinnhutte_select_add_simple_line_icon_pack_option' );
	add_filter( 'diefinnhutte_select_filter_add_icon_pack_into_social_options', 'diefinnhutte_select_add_simple_line_icon_pack_option' );
}

class DieFinnhutteSelectClassSimpleLineIcons implements iDieFinnhutteSelectInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'diefinnhutte'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'diefinnhutte'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'diefinnhutte'),
            'icon-social-facebook'    => esc_html__('Facebook', 'diefinnhutte'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'diefinnhutte'),
            'icon-social-github'      => esc_html__('Github', 'diefinnhutte'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'diefinnhutte'),
            'icon-social-instagram'   => esc_html__('Instagram', 'diefinnhutte'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'diefinnhutte'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'diefinnhutte'),
            'icon-social-reddit'      => esc_html__('Reddit', 'diefinnhutte'),
            'icon-social-skype'       => esc_html__('Skype', 'diefinnhutte'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'diefinnhutte'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'diefinnhutte'),
            'icon-social-spotify'     => esc_html__('Spotify', 'diefinnhutte'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'diefinnhutte'),
            'icon-social-twitter'     => esc_html__('Twitter', 'diefinnhutte'),
            'icon-social-youtube'     => esc_html__('Youtube', 'diefinnhutte')
        );
    }
