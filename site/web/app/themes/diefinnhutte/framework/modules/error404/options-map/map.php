...
if ( ! function_exists( 'diefinnhutte_select_error_404_options_map' ) ) {
	function diefinnhutte_select_error_404_options_map() {
		
		diefinnhutte_select_add_admin_page(
			array(
				'slug'  => '__404_error_page',
				'title' => esc_html__( '404 Error Page', 'diefinnhutte' ),
				'icon'  => 'fa fa-exclamation-triangle'
			)
		);
		
		$panel_404_header = diefinnhutte_select_add_admin_panel(
			array(
		...
		diefinnhutte_select_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a border bottom color for header area', 'diefinnhutte' )
			)
		);
		...
		$panel_404_options = diefinnhutte_select_add_admin_panel(
			array(
				'page'  => '__404_error_page',
				'name'  => 'panel_404_options',
				'title' => esc_html__( '404 Page Options', 'diefinnhutte' )
			)
		);
		...
		diefinnhutte_select_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a background image for 404 page', 'diefinnhutte' )
			)
		);
		...
		diefinnhutte_select_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a pattern image for 404 page', 'diefinnhutte' )
			)
		);
		...
		diefinnhutte_select_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Title Image', 'diefinnhutte' ),
				'description' => esc_html__( 'Choose a background image for displaying above 404 page Title', 'diefinnhutte' )
			)
		);
		...
		diefinnhutte_select_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Enter title for 404 page. Default label is "404".', 'diefinnhutte' )
			)
		);
		...
		$first_level_group = diefinnhutte_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Title Style', 'diefinnhutte' ),
				'description' => esc_html__( 'Define styles for 404 page title', 'diefinnhutte' )
			)
		);
        ...
        $first_level_group_responsive = diefinnhutte_select_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'first_level_group_responsive',
                'title'       => esc_html__( 'Title Style Responsive', 'diefinnhutte' ),
                'description' => esc_html__( 'Define responsive styles for 404 page title (under 680px)', 'diefinnhutte' )
            )
        );
		...
		diefinnhutte_select_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Enter subtitle for 404 page. Default label is "PAGE NOT FOUND".', 'diefinnhutte' )
			)
		);
		...
		$second_level_group = diefinnhutte_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Subtitle Style', 'diefinnhutte' ),
				'description' => esc_html__( 'Define styles for 404 page subtitle', 'diefinnhutte' )
			)
		);
        ...
        $second_level_group_responsive = diefinnhutte_select_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'second_level_group_responsive',
                'title'       => esc_html__( 'Subtitle Style Responsive', 'diefinnhutte' ),
                'description' => esc_html__( 'Define responsive styles for 404 page subtitle (under 680px)', 'diefinnhutte' )
            )
        );
		...
		diefinnhutte_select_add_admin_field(
			array(
				...
				'name'          => '404_text',
				'default_value' => '',
				'label'         => esc_html__( 'Text', 'diefinnhutte' ),
				'description'   => esc_html__( 'Enter text for 404 page.', 'diefinnhutte' )
			)
		);
		...
		$third_level_group = diefinnhutte_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Text Style', 'diefinnhutte' ),
				'description' => esc_html__( 'Define styles for 404 page text', 'diefinnhutte' )
			)
		);
        ...
        $third_level_group_responsive = diefinnhutte_select_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'third_level_group_responsive',
                'title'       => esc_html__( 'Text Style Responsive', 'diefinnhutte' ),
                'description' => esc_html__( 'Define responsive styles for 404 page text (under 680px)', 'diefinnhutte' )
            )
        );
		...
		diefinnhutte_select_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Back to Home Button Label', 'diefinnhutte' ),
				'description' => esc_html__( 'Enter label for "Back to home" button', 'diefinnhutte' )
			)
		);
		...
		diefinnhutte_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Skin', 'diefinnhutte' ),
				'description'   => esc_html__( 'Choose a style to make Back to Home button in that predefined style', 'diefinnhutte' ),
				'options'       => array(
					''            => esc_html__( 'Default', 'diefinnhutte' ),
					'light-style' => esc_html__( 'Light', 'diefinnhutte' )
				)
			)
		);
	}
	
	add_action( 'diefinnhutte_select_action_options_map', 'diefinnhutte_select_error_404_options_map', diefinnhutte_select_set_options_map_position( '404' ) );
}