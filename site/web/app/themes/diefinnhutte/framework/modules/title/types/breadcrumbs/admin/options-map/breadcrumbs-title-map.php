...
if ( ! function_exists('diefinnhutte_select_breadcrumbs_title_type_options_map') ) {
	function diefinnhutte_select_breadcrumbs_title_type_options_map($panel_typography) {
		
		diefinnhutte_select_add_admin_section_title(
			array(
				'name'   => 'type_section_breadcrumbs',
				'title'  => esc_html__( 'Breadcrumbs', 'diefinnhutte' ),
				'parent' => $panel_typography
			)
		);
	
		$group_page_breadcrumbs_styles = diefinnhutte_select_add_admin_group(
			array(
				'name'        => 'group_page_breadcrumbs_styles',
				'title'       => esc_html__( 'Breadcrumbs', 'diefinnhutte' ),
				'description' => esc_html__( 'Define styles for page breadcrumbs', 'diefinnhutte' ),
				'parent'      => $panel_typography
			)
		);
	
			$row_page_breadcrumbs_styles_1 = diefinnhutte_select_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_2 = diefinnhutte_select_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_3 = diefinnhutte_select_add_admin_row(
				array(
	...
	add_action( 'diefinnhutte_select_action_additional_title_typography_options_map', 'diefinnhutte_select_breadcrumbs_title_type_options_map');
}