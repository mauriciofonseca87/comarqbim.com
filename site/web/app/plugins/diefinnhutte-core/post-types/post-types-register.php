...
namespace DieFinnhutteCore\CPT;

use DieFinnhutteCore\Lib;

/**
 * Class PostTypesLoader
 * @package DieFinnhutteCore\CPT
 */
class PostTypesRegister {
	...
	private function addPostTypes() {
		$cpt_class_name = apply_filters( 'diefinnhutte_core_filter_register_custom_post_types', $cpt_class_name = array() );
