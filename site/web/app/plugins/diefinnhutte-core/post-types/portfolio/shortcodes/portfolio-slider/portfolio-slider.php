...
class PortfolioSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Slider', 'diefinnhutte-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Items', 'diefinnhutte-core' ),
							'admin_label' => true,
							'description' => esc_html__( 'Set number of items for your portfolio slider. Enter -1 to show all', 'diefinnhutte-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Number of portfolios that are showing at the same time in slider (on smaller screens is responsive so there will be less items shown). Default value is Four', 'diefinnhutte-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Set image proportions for your portfolio slider.', 'diefinnhutte-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'autocomplete',
                        ...
                        array(
                            ...
                            'heading'    => esc_html__( 'Fullheight slider?', 'diefinnhutte-core' ),
                        ...
                        array(
                            ...
                            'heading'     => esc_html__( 'Decrease Slider Height? Enter the value in % to decrease slider height for', 'diefinnhutte-core' ),
                            'dependency' => array( 'element' => 'enable_fullheight', 'value' => array( 'yes') ),
                        ),
						array(
							'type'        => 'dropdown',
                        ...
                        array(
                            ...
                            'heading'     => esc_html__( 'Enable Mousewheel scroll', 'diefinnhutte-core' ),
                            'value'       => array_flip( diefinnhutte_select_get_yes_no_select_array( false, false ) ),
                            'save_always' => true,
                            'group'       => esc_html__( 'Slider Settings', 'diefinnhutte-core' )
                        ),
						...
						array(
							...
							'heading'    => esc_html__( 'Navigation Skin', 'diefinnhutte-core' ),
							'value'      => array(
								esc_html__( 'Default', 'diefinnhutte-core' ) => '',
								esc_html__( 'Light', 'diefinnhutte-core' )   => 'light',
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Skin', 'diefinnhutte-core' ),
							'value'      => array(
								esc_html__( 'Default', 'diefinnhutte-core' ) => '',
								esc_html__( 'Light', 'diefinnhutte-core' )   => 'light',
								esc_html__( 'Dark', 'diefinnhutte-core' )    => 'dark'
						...
						array(
							...
							'heading'     => esc_html__( 'Pagination Position', 'diefinnhutte-core' ),
							'value'       => array(
								esc_html__( 'Below Slider', 'diefinnhutte-core' ) => 'below-slider',
								esc_html__( 'On Slider', 'diefinnhutte-core' )    => 'on-slider'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'enable_pagination', 'value' => array( 'yes' ) ),
							'group'       => esc_html__( 'Slider Settings', 'diefinnhutte-core' )
	...
	public function render( $atts, $content = null ) {
		...
		$params['mouse_scroll'] = $params['enable_mousewheel_scroll'];

        $additional_class = '';
		if($params['mouse_scroll'] === 'yes') {
		    $additional_class = 'qodef-portfolio-slider-mousewheel-scroll';
        }

		$html = '<div class="qodef-portfolio-slider-holder '.esc_attr($additional_class).'">';
