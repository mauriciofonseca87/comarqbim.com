...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'diefinnhutte-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'diefinnhutte-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'If you left this field empty then project ID will be of the current page', 'diefinnhutte-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'project_info_type',
							'heading'     => esc_html__( 'Project Info Type', 'diefinnhutte-core' ),
							'value'       => array(
								esc_html__( 'Title', 'diefinnhutte-core' )          => 'title',
								esc_html__( 'Category', 'diefinnhutte-core' )       => 'category',
								esc_html__( 'Tag', 'diefinnhutte-core' )            => 'tag',
								esc_html__( 'Author', 'diefinnhutte-core' )         => 'author',
								esc_html__( 'Date', 'diefinnhutte-core' )           => 'date',
								esc_html__( 'Featured Image', 'diefinnhutte-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'diefinnhutte-core' ),
							'value'       => array_flip( diefinnhutte_select_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'diefinnhutte-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'diefinnhutte-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'diefinnhutte-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'diefinnhutte-core' ),
							'value'      => array_flip( diefinnhutte_select_get_title_tag( true, array( 'p' => 'p' ) ) ),
