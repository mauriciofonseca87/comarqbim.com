<?php
if ( ! function_exists( 'diefinnhutte_select_init_google_fonts_array' ) ) {
    function diefinnhutte_select_init_google_fonts_array() {
        ...
        $diefinnhutte_select_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'diefinnhutte_select_init_google_fonts_array');
}