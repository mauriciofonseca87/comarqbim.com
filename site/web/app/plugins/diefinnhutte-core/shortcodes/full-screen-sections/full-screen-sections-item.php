<?php
namespace DieFinnhutteCore\CPT\Shortcodes\FullScreenSections;
...
class FullScreenSectionsItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Full Screen Sections Item', 'diefinnhutte-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'heading'    => esc_html__('Background Image', 'diefinnhutte-core')
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'background_position',
							'heading'     => esc_html__( 'Background Image Position', 'diefinnhutte-core' ),
							'description' => esc_html__( 'Please insert position in format horizontal vertical position, example - center center', 'diefinnhutte-core' ),
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'background_size',
							'heading'     => esc_html__( 'Background Image Size', 'diefinnhutte-core' ),
							'value'       => array(
								esc_html__( 'Cover', 'diefinnhutte-core' )   => 'cover',
								esc_html__( 'Contain', 'diefinnhutte-core' ) => 'contain',
								esc_html__( 'Inherit', 'diefinnhutte-core' ) => 'inherit'
							),
							'save_always' => true,
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'padding',
							'heading'     => esc_html__( 'Content Padding', 'diefinnhutte-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. You can use px or %', 'diefinnhutte-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'vertical_alignment',
							'heading'     => esc_html__( 'Content Vertical Alignment', 'diefinnhutte-core' ),
							'value'       => array(
								esc_html__( 'Default', 'diefinnhutte-core' ) => '',
								esc_html__( 'Top', 'diefinnhutte-core' )     => 'top',
								esc_html__( 'Middle', 'diefinnhutte-core' )  => 'middle',
								esc_html__( 'Bottom', 'diefinnhutte-core' )  => 'bottom'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Content Horizontal Alignment', 'diefinnhutte-core' ),
							'value'       => array(
								esc_html__( 'Default', 'diefinnhutte-core' ) => '',
						...
						array(
							...
							'description' => esc_html__( 'Set custom link around item', 'diefinnhutte-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Header and Navigation Skin', 'diefinnhutte-core' ),
							'value'       => array(
								esc_html__( 'Default', 'diefinnhutte-core' ) => '',
							...
							'save_always' => true,
							'description' => esc_html__( 'Choose a predefined header style for header elements and for full screen sections navigation/pagination', 'diefinnhutte-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_laptop',
							'heading'     => esc_html__('Background Image for Laptops', 'diefinnhutte-core'),
							'group'       => esc_html__('Responsiveness', 'diefinnhutte-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet',
							'heading'     => esc_html__('Background Image for Tablets - Landscape', 'diefinnhutte-core'),
							'group'       => esc_html__('Responsiveness', 'diefinnhutte-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet_portrait',
							'heading'     => esc_html__('Background Image for Tablets - Portrait', 'diefinnhutte-core'),
							'group'       => esc_html__('Responsiveness', 'diefinnhutte-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_mobile',
							'heading'     => esc_html__('Background Image for Mobiles', 'diefinnhutte-core'),
							'group'       => esc_html__('Responsiveness', 'diefinnhutte-core')
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = diefinnhutte_core_get_shortcode_module_template_part( 'templates/full-screen-sections-item', 'full-screen-sections', '', $params );
