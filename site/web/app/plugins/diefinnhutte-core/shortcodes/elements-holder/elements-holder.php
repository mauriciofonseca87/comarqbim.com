...
class ElementsHolder implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Elements Holder', 'diefinnhutte-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Holder Full Height', 'diefinnhutte-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Columns', 'diefinnhutte-core' ),
							'value'       => array(
								esc_html__( '1 Column', 'diefinnhutte-core' )  => 'one-column',
								esc_html__( '2 Columns', 'diefinnhutte-core' ) => 'two-columns',
								esc_html__( '3 Columns', 'diefinnhutte-core' ) => 'three-columns',
								esc_html__( '4 Columns', 'diefinnhutte-core' ) => 'four-columns',
								esc_html__( '5 Columns', 'diefinnhutte-core' ) => 'five-columns',
								esc_html__( '6 Columns', 'diefinnhutte-core' ) => 'six-columns'
							),
							'save_always' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Items Float Left', 'diefinnhutte-core' ),
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Never', 'diefinnhutte-core' )        => 'never'
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Choose Alignment In Responsive Mode', 'diefinnhutte-core' ),
							'value'       => array(
								esc_html__( 'Default', 'diefinnhutte-core' ) => '',
							...
							'description' => esc_html__( 'Alignment When Items are in One Column', 'diefinnhutte-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div ' . diefinnhutte_select_get_class_attribute( $holder_classes ) . ' ' . diefinnhutte_select_get_inline_attr( $holder_styles, 'style' ) . '>';
