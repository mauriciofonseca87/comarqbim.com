<?php
namespace DieFinnhutteCore\CPT\Shortcodes\ClientsGrid;
...
class ClientsGrid implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if(function_exists('vc_map')) {
			vc_map(
				array(
					'name'      => esc_html__( 'Clients Grid', 'diefinnhutte-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Items Horizontal Alignment', 'diefinnhutte-core' ),
							'value'       => array(
								esc_html__( 'Default Center', 'diefinnhutte-core' ) => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Items Hover Animation', 'diefinnhutte-core' ),
							'value'       => array(
								esc_html__( 'Switch Images', 'diefinnhutte-core' ) => 'switch-images',
								esc_html__( 'Roll Over', 'diefinnhutte-core' )     => 'roll-over'
							),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = diefinnhutte_core_get_shortcode_module_template_part( 'templates/clients-grid', 'clients-grid', '', $params );
