<?php
namespace DieFinnhutteCore\CPT\Shortcodes\Dropcaps;
...
class Dropcaps implements Lib\ShortcodeInterface {
	...
	public function render( $atts, $content = null ) {
		...
		$html = diefinnhutte_core_get_shortcode_module_template_part( 'templates/dropcaps-template', 'dropcaps', '', $params );
