					...
					<div class="qodef-team-social-outer">
						<div class="qodef-team-social-inner">
							<?php if ($team_position !== "") { ?>
                                <h5 class="qodef-team-position" <?php echo diefinnhutte_select_get_inline_style($team_position_styles); ?>><?php echo esc_html($team_position); ?></h5>
							<?php } ?>
							<?php if ($team_name !== '') { ?>
                            ...
                            <?php if ($team_social_text === 'yes') {?>
                                <div class="qodef-team-social-text-holder">
                                    <?php if(!empty($team_social_text_1)) {?>
                                        <a href="<?php echo esc_url($team_social_link_1)?>" target="_blank"><?php echo esc_html($team_social_text_1)?></a>
                                    <?php }?>
	                                <?php if(!empty($team_social_text_2)) {?>
                                        <a href="<?php echo esc_url($team_social_link_2)?>" target="_blank"><?php echo esc_html($team_social_text_2)?></a>
	                                <?php }?>
	                                <?php if(!empty($team_social_text_3)) {?>
                                        <a href="<?php echo esc_url($team_social_link_3)?>" target="_blank"><?php echo esc_html($team_social_text_3)?></a>
	                                <?php }?>
                                </div>
                            <?php }?>
						</div>
