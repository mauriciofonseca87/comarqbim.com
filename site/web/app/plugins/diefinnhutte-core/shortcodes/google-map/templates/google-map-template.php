<div class="qodef-google-map-holder">
	<?php if ( ! empty( $address1 ) && $enable_direction_link === 'yes' ) {
		...
		?>
		<a itemprop="url" class="qodef-google-map-direction" href="<?php echo esc_url( $get_direction_link ); ?>" target="_blank"><?php esc_html_e( 'Get direction', 'diefinnhutte-core' ); ?></a>
	<?php } ?>
