<?php
namespace DieFinnhutteCore\CPT\Shortcodes\SingleImage;
...
class SingleImage implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Single Image', 'diefinnhutte-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Moving on Hover', 'diefinnhutte-core' )  => 'moving'
							)
						),
                        array(
                            'type'        => 'dropdown',
	...
	public function render( $atts, $content = null ) {
		...
		$html = diefinnhutte_core_get_shortcode_module_template_part( 'templates/single-image', 'single-image', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = $params['enable_image_movement'] === 'yes' ? 'qodef-image-hover-move' : '';
