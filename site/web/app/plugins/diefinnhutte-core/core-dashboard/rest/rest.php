...
if ( ! class_exists( 'DiefinnhutteCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class DiefinnhutteCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'diefinnhutte-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'diefinnhutte_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	DiefinnhutteCoreDashboardRestAPI::get_instance();
}