...
include 'diefinnhutte-instagram-helper.php';

/**
 * Class DieFinnhutteInstagramApi
 */
class DieFinnhutteInstagramApi {
	...
	const INSTAGRAM_CODE = 'diefinnhutte_instagram_code';
	const INSTAGRAM_USER_ID = 'diefinnhutte_instagram_user_id';
	const INSTAGRAM_TOKEN = 'diefinnhutte_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'diefinnhutte_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'diefinnhutte_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'diefinnhutte_facebook_code';
	const FACEBOOK_TOKEN = 'diefinnhutte_facebook_access_token';

	const CONNECTION_TYPE = 'diefinnhutte_connection_type';
	...
	public function __construct() {
		...
		$this->helper = new DieFinnhutteInstagramHelper();
	}
	...
	/**
	 * @return DieFinnhutteInstagramApi
	 */
	...
	/**
	 * @return DieFinnhutteInstagramHelper
	 */
	 ...
	 *
	 * @see DieFinnhutteInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see DieFinnhutteInstagramApi::instagramExchangeCodeForToken()
	 */
