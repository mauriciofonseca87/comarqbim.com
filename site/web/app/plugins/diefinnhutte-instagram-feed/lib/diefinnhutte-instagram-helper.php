...
/**
 * Class DieFinnhutteInstagramHelper
 */
class DieFinnhutteInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines diefinnhutte_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image ) {
		...
		$imageAtts = apply_filters( 'diefinnhutte_instagram_image_atts',
			array(
